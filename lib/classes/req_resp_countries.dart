...
//
//     final dataColombia = dataColombiaFromJson(jsonString);
...
DataColombia dataColombiaFromJson(String str) =>
    DataColombia.fromJson(json.decode(str));

String dataColombiaToJson(DataColombia data) => json.encode(data.toJson());
...
class DataColombia {
  ...
  factory DataColombia.fromJson(Map<String, dynamic> json) => DataColombia(
        name: json['name'],
